...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *OAuthManagement*):
...
Execute unit tests
```
    cd "OAuthManagement/test/OAuthManagement.Tests"
    dotnet test
```

Deploy application
```
    cd "OAuthManagement/src/OAuthManagement"
